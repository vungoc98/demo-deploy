...
export class DanhSachSanPhamComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    const url = "https://ngoc-demo-deploy-app.herokuapp.com/getProviderProducts-NCC";
  ...
  async onSearch(formSearch) { 
    ...
    const url = "https://ngoc-demo-deploy-app.herokuapp.com/searchProduct-NCC";
    const headers = new Headers({ 'Content-Type': 'application/json' });
  ...
  async deleteProducts( ) {
    ...
    if (ok == true) {
      ...
      if (this.array_deleteProducts.length == 0) {  
        ...
        const url = "https://ngoc-demo-deploy-app.herokuapp.com/deleteProducts-NCC";
        const headers = new Headers({ 'Content-Type': 'application/json' });
