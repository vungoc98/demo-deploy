...
export class ThemSanPhamComponent implements OnInit {
  ...
  async ngOnInit() { 
    ...
    const url = "https://ngoc-demo-deploy-app.herokuapp.com/getProductsNotProvider-NCC";
  ...
  async onSearch(formSearch) {  
    ...
    this.display_products.splice(0, this.display_products.length);  
    const url = "https://ngoc-demo-deploy-app.herokuapp.com/searchProductNotProvider-NCC";
    const headers = new Headers({ 'Content-Type': 'application/json' });
  ...
  async insertProduct() {
    const url = "https://ngoc-demo-deploy-app.herokuapp.com/addProviderProducts-NCC";
    const headers = new Headers({ 'Content-Type': 'application/json' });
