...
export class DanhSachHangHoaComponent implements OnInit {
  ...
  async ngOnInit() { 
    ...
    this.products.splice(0, this.products.length);
  	...
  	var url = "https://ngoc-demo-deploy-app.herokuapp.com/getMenuProduct";
    ...
    url = "https://ngoc-demo-deploy-app.herokuapp.com/getProduct_Type";
  ...
  async onSearch(formSearch) { 
    ...
    if (this.products.length > this.number) {
